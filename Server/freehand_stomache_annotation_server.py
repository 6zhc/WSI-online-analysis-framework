...
freehand_annotation_data_root = "static/data/freehand_stomache_annotation_data/"


def add_annotation_sever(app):
    @app.route('/freehand_stomache_annotation', methods=['GET', 'POST'])
    @login_required
    def freehand_stomache_annotation():
        ...
        return render_template('freehand_stomache_annotation.html', slide_url=slide_url, slide_id=slide_id,
                               annotator_id=annotator_id, slide_uuid=info[1], project=annotation_project)

    @app.route('/freehand_stomache_annotation/_get_info')
    @login_required
    def freehand_stomache_annotation_get_info():
    ...
    @app.route('/freehand_stomache_annotation/_clear_lines')
    @login_required
    def freehand_stomache_annotation_clear_lines():
        slide_id = request.args.get('slide_id', default=1, type=int)
        annotator_id = request.args.get('annotator_id', default=1, type=int)
        annotation_project = request.args.get('project', default="None", type=str)
        slide_uuid = request.args.get('slide_uuid', default="", type=str)
    ...
    @app.route('/freehand_stomache_annotation/_undo_lines')
    @login_required
    def freehand_stomache_annotation_undo_lines():
        slide_id = request.args.get('slide_id', default=1, type=int)
        annotator_id = request.args.get('annotator_id', default=1, type=int)
        annotation_project = request.args.get('project', default="None", type=str)
        slide_uuid = request.args.get('slide_uuid', default="", type=str)
    ...
    @app.route('/freehand_stomache_annotation/_update_image')
    @login_required
    def freehand_stomache_annotation_update_image():
        slide_id = request.args.get('slide_id', default=1, type=int)
        annotator_id = request.args.get('annotator_id', default=1, type=int)
        annotation_project = request.args.get('project', default="None", type=str)
        slide_uuid = request.args.get('slide_uuid', default="", type=str)
        ...
        db = freehand_annotation_sqlite.SqliteConnector(annotaion_db)
        color = [[0,0,139,255],[255,0,255,255],[128,0,128,255],[130,0,75,255],[226,43,138,255],[255,0,0,255],[255,105,65,255],[180,130,70,255],[255,255,0,255],[0,255,0,255],[0,128,0,255],[0,255,255,255],[0,215,255,255],[0,165,255,255],[0,0,255,255],[0,0,0,255],[0,100,0,255],[50,205,50,255],[143,188,143,255]]
        # print(db.get_lines())
    ...
    @app.route('/freehand_stomache_annotation/_record', methods=['GET', 'POST'])
    @login_required
    def freehand_stomache_annotation_record():
        slide_id = request.args.get('slide_id', default=1, type=int)
        annotator_id = request.args.get('annotator_id', default=1, type=int)
        annotation_project = request.args.get('project', default="None", type=str)
        slide_uuid = request.args.get('slide_uuid', default="", type=str)
