...
var update_image_info = function () {
    $.getJSON('/freehand_stomache_annotation/_get_info' + info_url, {}, function (data) {  //get inform and create radio button,
...
var add_mask = function () {
    ...
    $.getJSON('/freehand_stomache_annotation/_update_image' + info_url, data_askFor, //asking for the new image
        function (data) {
